#!/bin/bash
# Tears down the ComfyUI stack completely.
...
# The workspace volume contains all downloaded models (FLUX models are ~25 GB)
# as well as generated outputs, custom nodes, and configuration.
# After teardown, re-running start.sh triggers provisioning and re-downloads everything.
set -e
...
echo ""
echo "Volumes  (ALL DATA WILL BE LOST — models, outputs, configs, custom nodes):"
...
echo ""
echo "Done. Re-run start.sh to create a fresh installation (provisioning will re-download models)."
