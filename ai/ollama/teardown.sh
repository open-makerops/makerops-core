#!/bin/bash
# Tears down the Ollama stack completely.
...
# The ollama_data volume may be very large (each model is 1–70+ GB).
# After teardown, re-running start.sh and pulling models creates a fresh installation.
set -e
...
echo ""
echo "Volumes  (ALL DATA WILL BE LOST — including all downloaded models):"
...
echo ""
echo "Done. Re-run start.sh and pull models to create a fresh installation."
